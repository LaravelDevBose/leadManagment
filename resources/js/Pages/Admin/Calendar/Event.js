...
export default class Event {
  constructor (event = {}) {
    ...
    this.bgColor = this.eventColor(event.calendarId).bgColor? this.eventColor(event.calendarId).bgColor: '#f89635'
    this.dragBgColor = this.eventColor(event.calendarId).dragBgColor? this.eventColor(event.calendarId).dragBgColor: '#f9ad61'
    this.borderColor = this.eventColor(event.calendarId).borderColor ? this.eventColor(event.calendarId).borderColor: '#ec8a29'
