...
<head>
    ...
    <!-- Favicons -->
    <link href="{{ asset('public/assets/img/home.png') }}" rel="icon">
    <!-- Google Fonts -->
    ...
    <link rel="stylesheet" href="{{ asset('public/assets/css/animation/animate.css') }}">
...
<script src="{{ asset('public/assets/js/wow/wow.min.js') }}"></script>
